...
public class RentalSystem_Final {
    public static void main(String[] args) {
        ...
        // --- 기본 물품 생성 로직 수정 ---
        if (items.isEmpty()) {
            // Item(이름, 재고, 기본요금, 보증금, 반납기한(일))
            items.add(new Item("3단 우산", 10, 1000.0, 3000, 3));
            items.add(new Item("축구공", 5, 2000.0, 3000, 2));
            items.add(new Item("보조배터리", 15, 1500.0, 3000, 2));
            items.add(new Item("C타입 충전기", 20, 500.0, 3000, 3));
            items.add(new Item("8핀 충전기", 20, 500.0, 3000, 3));
        }
        // ---------------------------------
