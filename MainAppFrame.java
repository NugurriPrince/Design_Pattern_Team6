// 기능 : 메인 애플리케이션 프레임, GUI 구성 및 이벤트 처리
...
public class MainAppFrame extends JFrame implements Observer {
    ...
    private JPanel createControlPanel() {
        ...
        gbc.gridx = 0; gbc.gridy = 1; gbc.gridwidth = 1; panel.add(new JLabel("물품 선택:"), gbc);
        gbc.gridx = 1; gbc.gridy = 1; panel.add(itemComboBox, gbc);
        gbc.gridx = 0; gbc.gridy = 2; gbc.gridwidth = 2; panel.add(strategyLabel, gbc);
